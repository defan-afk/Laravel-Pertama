                                ...
                                <div class="xp-social-profile-img">
                                    <div class="row">
                                        <div class="col-4 px-1">
                                            <img src="{{asset('foto/wallpaperbetter (2).jpg') }}" class="rounded img-fluid" alt="img">
                                        </div>
                                        <div class="col-4 px-1">
                                            <img src="{{asset('foto/wallpaperbetter (3).jpg') }}" class="rounded img-fluid" alt="img">
                                        </div>
                                        <div class="col-4 px-1">
                                            <img src="{{asset('foto/wallpaperbetter (4).jpg') }}" class="rounded img-fluid" alt="img">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 mt-3">
                                            <div class="xp-social-profile-avatar text-center">
                                                <img src="{{asset('foto/wallpaperbetter (5).jpg') }}" alt="user-profile" class="rounded-circle img-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="xp-social-profile-title">
                                                <h5 class="my-1 text-black">_defan_</h5>
                                            </div>
                                            <div class="xp-social-profile-subtitle">
                                                <p class="mb-3 text-muted">Getar jagat dewantara</p>
                                            </div>
                                            <div class="xp-social-profile-desc">
                                                <p class="text-muted">"Jangan takut berjalan lambat, takutlah jika hanya berdiri diam." <br>Kelas 6B Nim 18090023</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
